...
template <> struct ToString_<Type::Error> final {
    inline constexpr static auto const * value = "Error";
};

template <> struct ToString_<Type::Warning> final {
    inline constexpr static auto const * value = "Warning";
};

template <> struct ToString_<Type::Info> final {
    inline constexpr static auto const * value = "Info";
};

template <> struct ToString_<Type::Debug> final {
    inline constexpr static auto const * value = "Debug";
};

template <> struct ToString_<Type::Developer> final {
    inline constexpr static auto const * value = "Developer";
};

template <Type value> inline constexpr static auto const * to_string() noexcept(true) {
    return ToString_<value>::value;
}

inline static auto const * to_string(Type const &value) noexcept(false) {
    thread_local static auto const map_ = ::std::unordered_map<Type, ::std::string_view> {
...
inline constexpr static auto unknown(Type const &value) noexcept(true) {
    ...
    if (static_cast<bool>(file_) && static_cast<bool>(*file_) && (empty_.file_name() != file_)) return false;
    auto const * const function_ = value.function_name();
    return ! (static_cast<bool>(function_) && static_cast<bool>(*function_) && (empty_.function_name() != function_));
}
